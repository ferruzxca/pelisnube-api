...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [125 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12510600; uint32_t buffer_offset
	}, ; 122: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12681608; uint32_t buffer_offset
	}, ; 123: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2040832, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12704168; uint32_t buffer_offset
	} ; 124: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14745000, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14745000 x i8] zeroinitializer, align 16
